...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col justify-between p-2 md:p-4 text-slate-300">
      {/* TOP TELEMETRY BAR */}
      <header className="mx-auto mb-3 w-full max-w-7xl">
        <div className="housing-bevel relative overflow-hidden rounded-lg p-2 md:p-3">
            ...
            <div className="flex items-center gap-3 pl-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="font-orbitron text-base font-extrabold uppercase tracking-wider text-slate-100 md:text-lg">
                    Unit Converter
                  </h1>
      ...
      {/* FOOTER */}
      <footer className="mx-auto mt-4 w-full max-w-7xl border-t border-slate-800/80 pt-2 text-center font-mono text-[10px] text-slate-600">
