...
import type { ConvertResult } from "@/types/conversion";
...
export default function LengthConverter() {
  ...
  return (
    ...
    >
      ...
      <UnitSelect label="From unit" value={from} units={LENGTH_UNITS} onChange={setFrom} />
      <UnitSelect label="To unit" value={to} units={LENGTH_UNITS} onChange={setTo} />
