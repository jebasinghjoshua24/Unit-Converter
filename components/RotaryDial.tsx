    ...
    <div className="flex w-full flex-col items-center gap-3">
      ...
      <div className="relative my-2 flex h-64 w-64 items-center justify-center select-none">
        ...
        <div
          ...
          onWheel={handleWheel}
          className="relative flex h-44 w-44 cursor-grab touch-none items-center justify-center rounded-full border-2 border-slate-700 bg-gradient-to-br from-slate-800 via-slate-900 to-black shadow-[0_6px_16px_rgba(0,0,0,0.9),inset_0_2px_4px_rgba(255,255,255,0.15)] transition-transform duration-300 ease-out"
        ...
        >
          ...
          {/* center cap */}
          <div className="relative flex h-24 w-24 flex-col items-center justify-center rounded-full border border-slate-700/80 bg-gradient-to-tr from-slate-950 via-slate-900 to-slate-800 shadow-inner">
